...
agents_df$params
agents_df$params[[2]]$p_k 
agents_df$params[[4]]$p_k #DOES NOT SEEM TO GET IT RIGHT

compete(c(1,2), n_rounds = 100)
compete(c(3,4), n_rounds = 100)
compete(pair = c(10,2), n_rounds = 2)
