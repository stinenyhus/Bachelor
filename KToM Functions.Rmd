...
#To Do:
Make a Prepare Function
Decide on Priors
Fix all inputs smaller functions
...
rec_learning_function = function(
  ...
  if (level == 0) { #If the (simulated) agent is a 0-ToM
    ...
    for (level_index in 1:level) {
      ...
      new_hidden_states[[level_index]] = rec_learning_function(prev_hidden_states = prev_hidden_states[[level_index]],
                                                     params = param_mean[level_index],
                                                     choices = reverse_choices,
                                                     level = opponent_level,
                                                     player = opponent_player,
                                                     p_matrix = p_matrix) 
      ...
      mean[level_index] = decision_function(hidden_states = new_hidden_states[[level_index]],
                               choices = reverse_choices,
                               player = opponent_player,
                               p_matrix = p_matrix,
                               level = opponent_level)
      ...
      #Update gradient
      gradient[level_index] = gradient_update(opponent_prev_hidden_states = prev_hidden_states[[level_index]],
                                 mean,
