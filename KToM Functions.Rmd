...
#Add names to hidden states

#Does mean come out of decision function as probability, or in logodds?
...
#Matlab Code: Do the also take the absolute difference when calculating gradient?
...
gradient_update = function(opponent_prev_hidden_states, mean, param_mean, reverse_choices, opponent_level, opponent_player, p_matrix) {
  ...
  for (param in 1:length(param_mean)) {
      ...
      gradient[param] = abs((mean_incremented - mean))/increment   #!# Must check with Matlab Code
  }
...
rec_learning_function = function(
  ...
  if (level == 0) { #If the (simulated) agent is a 0-ToM
    ...
    for (level_index in 1:level) {
      ...
      new_opponent_hidden_states = rec_learning_function(prev_hidden_states = opponent_hidden_states,
                                                     ...
                                                     player = opponent_player,
                                                     p_matrix = p_matrix) 
      print("simulated an opponents learning")
      ...
      print("simulated an opponents decision")
  ...
  #paste("new_hidden_states$", opponent_level, "_ToM = new_opponent_hidden_states", sep = "")
...
#Full k-ToM function
```{r}
k_ToM = function (params = "default", hidden_states, player, level, p_matrix, choice_self, choice_op, return_hidden_states = T) {
