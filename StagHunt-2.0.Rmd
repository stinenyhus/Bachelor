...
p_load(plyr, tidyverse, raster, reshape2, knitr, brms, boot, rethinking, groupdata2, patchwork)
...
match_up <- function(agents_list, matchup_type){ 
  ...
  if (matchup_type == "random"){ 
    ...
    stop("This Matchup Type isn't ready yet")
  } else {
...
prepare_kToM <- function(k){
  ...
  sigma = inv.logit(rnorm(1, mean = logit(0.37), sd = 0.2)) #?# what is the values in the matlab code?
...
<<<<<<< HEAD:StagHunt 2.0.Rmd
strategies_manual <- c(rep("1-ToM", 9), rep("10-ToM", 1))
=======
strategies_manual <- c(rep("RB", 5), rep("0-ToM", 5))
>>>>>>> 7f01edc8a3bab607007eedddf800ed753d7ded26:StagHunt-2.0.Rmd
